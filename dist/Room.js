Room.prototype.run = function run () {
  ...
  if (!this.memory.UberQueue) this.memory.UberQueue = []
  ...
  this.runTaksSchedule(
    [
      ...
      { controllerLvl: [1, 8], schedule: 5, name: 'roomCoordinator', args: false },
      { controllerLvl: [2, 8], schedule: 16, name: 'defend', args: false },
      { controllerLvl: [3, 3], schedule: 511, name: 'controllerRoadMaker', args: false },
      { controllerLvl: [3, 4], schedule: 401, name: 'roadMaker', args: false },
      { controllerLvl: [3, 4], schedule: 451, name: 'buildBaseRoads', args: false },
      { controllerLvl: [5, 8], schedule: 999, name: 'queueRemote', args: ['claim', 5, [MOVE, MOVE, CLAIM, CLAIM]] }
    ]
  )
}
